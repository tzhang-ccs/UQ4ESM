...
class Turbo1:
    ...
    def optimize(self,  sampling_flag=True):
...
#                np.save("X_init_4P",X_init)
#                sys.exit()
                fX_init = np.array([[self.f(x)] for x in X_init])

#            else:
#                X_init = paraset.values
#
#                nsample = X_init.shape[0]
#                self.n_init = nsample
#
#                fX_init = scoreset['metrics'].values
#                fX_init = fX_init[:,np.newaxis]
#                #print(fX_init.shape)
